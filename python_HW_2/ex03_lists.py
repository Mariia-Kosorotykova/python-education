...
Exercise: In this exercise, you will need to add numbers and strings
...
second name in the names list, using the brackets operator []. Note
that the index is zero-based, so if you want to access the second item
...
if __name__ == "__main__":
    # this code should write out the filled arrays and
    # the second name in the names list (Eric).
    print(numbers)
    print(strings)
